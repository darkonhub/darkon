...
class Influence:
    ...
    @timing
    def _prepare(self, sess, test_indices, test_batch_size, force_refresh, approx_params=None):
    ...
    @timing
    def upweighting_influence_batch(self, sess, train_batch_size, train_iterations, subsamples=-1, force_refresh=False, **kwargs):
